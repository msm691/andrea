...
export function MainPage({ startAudio = false }: MainPageProps) {
  ...
  const videoUrl = 'https://r2.guns.lol/ffd6384f-abc0-4a81-b87d-06608d3f9b9b.mp4';
  ...
  const audioUrl = 'https://r2.guns.lol/1b0261c7-a8c8-4339-ae93-c9d5129a2ef5.mp3';
  ...
  const avatarUrl = 'https://i.ibb.co/prxqYYqW/andrea.png';
  
  // 4. 📝 Pour changer vos INFORMATIONS DE PROFIL :
  const username = 'Jeager';           // Votre pseudo
  const tag = '#madebykts';            // Votre tag/identifiant
  const description = 'UUID : 3';  // Votre description
